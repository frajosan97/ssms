                    ...
                    <div class="card-body p-1">
                        <ul class="list-group text-capitalize">
                            ...
                            <?php if (isset($_SESSION['ALUMNI'])) { ?>
                                <li class="list-group-item rounded-0"><a href="<?= ROOT ?>alumni/account"><i class="fas fa-angle-right"></i> account</a></li>
                                <li class="list-group-item rounded-0"><a href="<?= ROOT ?>alumni/create"><i class="fas fa-angle-right"></i> Add alumni page</a></li>
                            <?php } else { ?>
                                <li class="list-group-item rounded-0"><a href="<?= ROOT ?>alumni/login"><i class="fas fa-angle-right"></i> login</a></li>
                            <?php } ?>
                            <?php if (DPAGES) : ?>
                                <?php foreach (DPAGES as $key => $value) { ?>
                                    <li class="list-group-item rounded-0"><a href="<?= ROOT ?>alumni/<?= $value->page_key ?>"><i class="fas fa-angle-right"></i> <?= $value->page_sub_title ?></a></li>
                                <?php } ?>
                            <?php endif; ?>
                        </ul>
                    </div>
                    ...
                    <form class="dynamicPageForm">
                        <div class="card border-0 shadow-sm">
                            ...
                            <div class="card-footer border-0 bg-transparent mb-2">
                                ...
                                <button class="btn btn-outline-custom float-end"><i class="fas fa-user-plus"></i> Create Page</button>
                            </div>
                        </div>
                    </form>
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col d-flex justify-content-center align-items-center d-none d-sm-grid text-white">
                                    <p class="text-center">
                                        ...
                                        <a href="https://wa.me/<?= smartPhone(APPINFO->sch_phone) ?>/?text=Hello, i am an alumni of *<?= strtoupper(cleanHtml(APPINFO->sch_name)) ?>* and i hereby enquire for membership. Kindly guide me on the way forward." class="btn btn-outline-light">Request for membership now</a> <br><br>
                            ...
                            <div class="row">
                                        ...
                                        <div class="card-body">
                                            <form class="alumniSignUpForm">
                                                <ul class="list-group">
                                                    ...
                                                    <li class="list-group-item border-0 bg-transparent">
                                                        <button class="form-control pg-theme px-4 rounded text-white">Sign up</button>
                                                    </li>
                                                </ul>
                                            </form>
                                        </div>
                                ...
                                <div class="col d-flex justify-content-center align-items-center d-none d-sm-grid text-white">
                                    <p class="text-center">
                                        ...
                                        <a href="<?= ROOT ?>alumni/login" class="btn btn-outline-light">Login to your account</a>
                                    </p>
                                </div>
                            </div>
                        </div>
