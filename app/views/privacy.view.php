    ...
    <div class="container">
        <div class="card rounded-0 border-0">
            ...
            <ul>
                ...
                <li>
                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                        &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to <b
                            class="maincolor"><?= APPINFO->sch_name ?></b>, 43-90205 kabati.</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Website</strong> refers to <b class="maincolor"><?= APPINFO->sch_name ?></b>, accessible
                        from <a href="<?= ROOT ?>" rel="external nofollow noopener" target="_blank"><?= ROOT ?></a></p>
                </li>
                <li>
            ...
            <ul>
                ...
                <li>
                    <p>By visiting this page on our website: <a href="<?= ROOT ?>" rel="external nofollow noopener"
                            target="_blank"><?= ROOT ?></a></p>
                </li>
                <li>
