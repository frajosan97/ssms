!(function (t, e) {
  ...
  function xe(t) {
    return void 0 === t
      ...
      : u({ isConfirmed: !1, isDenied: !1, isDismissed: !1 }, t);
  }
  ...
  function Be(t, e, n) {
    var o = k(),
      ...
      u = n.didClose;
    Pe(e, s, r),
      i ? Oe(t, e, o, n.returnFocus, u || a) : ke(t, o, n.returnFocus, u || a);
  }
  ...
  var Ve = ["swal-title", "swal-html", "swal-footer"],
    ...
    gn = function (t) {
      -1 !== [T(), L(), D()].indexOf(document.activeElement) &&
        ((t =
          -1 !== ln.indexOf(t)
            ? "nextElementSibling"
  ...
  function An(t, e) {
    ...
    return (
      ((n = u({}, se, e, n, t)).showClass = u({}, se.showClass, n.showClass)),
      (n.hideClass = u({}, se.hideClass, n.hideClass)),
      !1 === t.animation &&
        ((n.showClass = {
  ...
  function xn(a, s, u) {
    return new Promise(function (t) {
      ...
      Ce.swalPromiseResolve.set(a, t),
        ...
        (r = a),
        "select" === (t = u).input || "radio" === t.input
          ? tn(r, t)
          : -1 !==
